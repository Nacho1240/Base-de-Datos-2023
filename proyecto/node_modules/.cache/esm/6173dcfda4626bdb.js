let express,Client;_a46‍.w("express",[["default",["express"],function(v){express=v}]]);_a46‍.w("pg",[["Client",["Client"],function(v){Client=v}]]);
...
client.connect()
  ...
  .catch(err => _a46‍.g.console.error('Error al conectar a la base de datos', err));
...
_a46‍.g.console.log(sol.rows);
res.json(sol.rows);
  }catch(e){
    _a46‍.g.console.log(e);
...
//relacion 
_a46‍.g.console.log(response.rows[0].id);
