let express,User,Evento,Jwt,jwtAuthenticated,getCurrentUser;_7a5‍.x([["default",()=>_7a5‍.o]]);_7a5‍.w("express",[["default",["express"],function(v){express=v}]]);_7a5‍.w("../models/user.js",[["default",["User"],function(v){User=v}]]);_7a5‍.w("../models/Event.js",[["default",["Evento"],function(v){Evento=v}]]);_7a5‍.w("jsonwebtoken",[["default",["Jwt"],function(v){Jwt=v}]]);_7a5‍.w("../helpers/jwtAuthenticated.js",[["default",["jwtAuthenticated"],function(v){jwtAuthenticated=v}]]);_7a5‍.w("../helpers/getCurrentUser.js",[["default",["getCurrentUser"],function(v){getCurrentUser=v}]]);
...
router.post('/crear-evento', (req, res) => {
  ...
  nuevoEvento.save()
      .then(eventoGuardado => {
          _7a5‍.g.console.log('Evento guardado:', eventoGuardado);
          res.render('user/evento-true'); // Redirige a una página de éxito
      })
      .catch(error => {
          _7a5‍.g.console.error('Error al guardar el evento:', error);
